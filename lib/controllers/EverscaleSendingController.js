...
var EverscaleWalletController = /** @class */ (function(_super) {
    ...
    function EverscaleWalletController(options) {
        if (options === void 0) {
            options = {};
        }
        var _this = _super.call(this, options) || this;
        _this.blockchainController = new _1.EverscaleBlockchainController(options);
        return _this;
    }
    // wallet block
    ...
    EverscaleWalletController.prototype.publishMessage = function(me, publicKey, chunks, recipientKeys) {
        return __awaiter(this, void 0, void 0, function() {
            var uniqueId,
                transaction,
                om,
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        decodedEvent = this.blockchainController.mailerContract.decodeContentMessageBody(
                            contentMsg.body,
                        );
                    ...
                    case 2:
                        if (!(
                                chunks.length === 1 &&
                                recipientKeys.length < Math.ceil((15.5 * 1024 - chunks[0].byteLength) / 70)
                            ))
                            return [3 /*break*/ , 4];
                        return [
                            4 /*yield*/ ,
                            this.blockchainController.mailerContract.sendBulkMail(
                                me.address,
                                publicKey,
                                uniqueId,
                                recipientKeys.map(function(r) {
                                    return r.address;
                                }),
                                recipientKeys.map(function(r) {
                                    return r.key;
                    ...
                    case 4:
                        ...
                        return [
                            4 /*yield*/ ,
                            this.blockchainController.mailerContract.buildHash(publicKey, uniqueId, initTime),
                        ];
                    case 5:
                        msgId = _a.sent();
                        i = 0;
                    ...
                    case 6:
                        ...
                        return [
                            4 /*yield*/ ,
                            this.blockchainController.mailerContract.sendMultipartMailPart(
                                me.address,
                                publicKey,
                                uniqueId,
                                initTime,
                    ...
                    case 10:
                        ...
                        return [
                            4 /*yield*/ ,
                            this.blockchainController.mailerContract.addRecipients(
                                me.address,
                                publicKey,
                                uniqueId,
                                initTime,
    ...
    // message send block
    EverscaleWalletController.prototype.sendNativeMessage = function(serviceCode, encryptedContent, key, recipients) {
        return __awaiter(this, void 0, void 0, function() {
            ...
            return __generator(this, function(_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [
                            4 /*yield*/ ,
                            this.blockchainController.ever.encryptData({
                                publicKey: me.publicKey,
                                recipientPublicKeys: recipients.map(function(r) {
                                    return r.publicKey;
                                }),
                    ...
                    case 2:
                        ...
                        recipientKeys = recipients.map(function(rec, idx) {
                            ...
                            return {
                                address: rec.address,
                                key: (0, sdk_1.packSymmetricalyEncryptedData)(
                                    smart_buffer_1.default.ofBase64String(kkey.data).bytes,
                                    smart_buffer_1.default.ofBase64String(kkey.nonce).bytes,
                                ),
                            };
                        });
