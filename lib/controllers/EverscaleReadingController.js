...
var EverscaleReadingController = /** @class */ (function (_super) {
    ...
    function EverscaleReadingController(options) {
        if (options === void 0) { options = {}; }
        var _this = _super.call(this, options) || this;
        _this.MESSAGES_FETCH_LIMIT = 50;
        if (options.endpoint) {
            _this.gqlAddress = options.endpoint;
        }
        else if (options.dev) {
            _this.gqlAddress = 'http://localhost/graphql';
        }
        else {
            _this.gqlAddress = 'https://gra02.main.everos.dev/graphql';
        }
    ...
    EverscaleReadingController.prototype.extractNativePublicKeyFromAddress = function (addressStr) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    EverscaleReadingController.prototype.decodeNativeKey = function (senderPublicKey, recipientPublicKey, key) {
        return __awaiter(this, void 0, void 0, function () {
