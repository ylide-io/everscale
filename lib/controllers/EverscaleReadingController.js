...
exports.EverscaleReadingController = void 0;
...
var EverscaleReadingController = /** @class */ (function (_super) {
    __extends(EverscaleReadingController, _super);
    function EverscaleReadingController(props) {
        ...
        _this.mailerContract = new contracts_1.MailerContract(_this, props.dev ? constants_1.DEV_MAILER_ADDRESS : constants_1.MAILER_ADDRESS);
        _this.registryContract = new contracts_1.RegistryContract(_this, props.dev ? constants_1.DEV_REGISTRY_ADDRESS : constants_1.REGISTRY_ADDRESS);
        return _this;
    }
    EverscaleReadingController.blockchainType = function () {
        return 'everscale';
    };
    EverscaleReadingController.prototype.getRecipientReadingRules = function (address) {
    ...
    EverscaleReadingController.prototype.extractAddressFromPublicKey = function (publicKey) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    EverscaleReadingController.prototype.extractPublicKeyFromAddress = function (address) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
    ...
    EverscaleReadingController.prototype.retrieveMessageHistoryByDates = function (recipientAddress, options) {
        var _a, _b, _c;
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 1:
                        _d.sent();
                        sinceDate = ((_a = options === null || options === void 0 ? void 0 : options.since) === null || _a === void 0 ? void 0 : _a.getTime()) ? ((_b = options === null || options === void 0 ? void 0 : options.since) === null || _b === void 0 ? void 0 : _b.getTime()) - 1 : null;
                        untilDate = ((_c = options === null || options === void 0 ? void 0 : options.to) === null || _c === void 0 ? void 0 : _c.getTime()) || null;
                        fullMessages = [];
                        _loop_1 = function () {
                            var messages, foundDuplicate, _e, _f, _g;
                            return __generator(this, function (_h) {
                                switch (_h.label) {
                                    case 0: return [4 /*yield*/, this_1.queryMessagesList(recipientAddress, sinceDate, untilDate, {
                                            nextPageAfterMessage: options === null || options === void 0 ? void 0 : options.nextPageAfterMessage,
                                            messagesLimit: options === null || options === void 0 ? void 0 : options.messagesLimit,
                                        })];
                                    case 1:
                                        messages = _h.sent();
                                        if (!messages.length)
                                        ...
                                        return [4 /*yield*/, Promise.all(messages.map(function (m) { return __awaiter(_this, void 0, void 0, function () {
                                                ...
                                                return __generator(this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0:
                                                            if (m.id === (options === null || options === void 0 ? void 0 : options.firstMessageIdToStopSearching)) {
                                                                foundDuplicate = true;
                                                            }
    ...
    EverscaleReadingController.prototype.gqlQueryMessages = function (query, variables) {
    ...
    EverscaleReadingController.prototype.gqlQuery = function (query, variables) {
        if (variables === void 0) { variables = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, fetch(this.gqlAddress, {
                            method: 'POST',
                            headers: {
    ...
    EverscaleReadingController.prototype.convertMsgIdToAddress = function (msgId) {
        return ":".concat(msgId);
    };
    EverscaleReadingController.prototype.retrieveAndVerifyMessageContent = function (msg) {
        return __awaiter(this, void 0, void 0, function () {
            var result;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    EverscaleReadingController.prototype.retrieveMessageContentByMsgId = function (msgId) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    EverscaleReadingController.prototype.formatPushMessage = function (message) {
    ...
    EverscaleReadingController.prototype.decodeMailText = function (senderAddress, recipient, data, nonce) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    EverscaleReadingController.prototype.isAddressValid = function (address) {
    ...
    EverscaleReadingController.prototype.queryMessagesList = function (recipientAddress, sinceDate, untilDate, options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    return EverscaleReadingController;
}(sdk_1.AbstractReadingController));
exports.EverscaleReadingController = EverscaleReadingController;
//# sourceMappingURL=EverscaleReadingController.js.map