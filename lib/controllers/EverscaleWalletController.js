...
const contract_wrappers_1 = require("../contract-wrappers");
class EverscaleWalletController extends sdk_1.AbstractWalletController {
    ...
    constructor(options = {}) {
        ...
        this.blockchainReader = new EverscaleBlockchainReader_1.EverscaleBlockchainReader(true, options?.endpoints || this.mainnetEndpoints, options.dev || false);
        ...
        const currentBroadcasterLink = contracts.broadcasterContracts.find(c => c.id === contracts.currentBroadcasterId);
    ...
    // Deployments:
    async deployMailerV5(me) {
        await this.ensureAccount(me);
        return await contract_wrappers_1.EverscaleMailerV5Wrapper.deploy(this.blockchainReader.ever, me);
    }
}
