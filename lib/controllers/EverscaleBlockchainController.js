...
var EverscaleBlockchainController = /** @class */ (function (_super) {
    ...
    EverscaleBlockchainController.prototype.queryMessagesList = function (recipientAddress, sinceDate, untilDate, options) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
    ...
    EverscaleBlockchainController.prototype.uint256ToAddress = function (value, withPrefix) {
        if (withPrefix === void 0) { withPrefix = true; }
        if (value.length !== 32) {
            throw new Error('Value must have 32-bytes');
        }
        return "".concat(withPrefix ? '0:' : '').concat(new smart_buffer_1.default(value).toHexString());
    };
