...
var MailerContract = /** @class */ (function () {
    ...
    MailerContract.prototype.buildHash = function (pubkey, uniqueId, time) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        result = _a.sent();
                        return [2 /*return*/, BigInt(result._hash).toString(16)];
                }
            });
        });
    };
    ...
    MailerContract.prototype.addRecipients = function (address, publicKey, uniqueId, initTime, recipients, keys) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contract.methods
                            ...
                            // @ts-ignore
                            keys: keys.map(function (k) { return new smart_buffer_1.default(k).toBase64String(); }),
                        })
                            .sendWithResult({
                            from: new everscale_inpage_provider_1.Address(address),
                            amount: '1000000000',
