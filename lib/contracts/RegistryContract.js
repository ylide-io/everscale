...
var RegistryContract = /** @class */ (function () {
    function RegistryContract(reader, contractAddress) {
        this.reader = reader;
        this.contractAddress = contractAddress;
        this.contract = new reader.ever.Contract(REGISTRY_ABI, new everscale_inpage_provider_1.Address(this.contractAddress));
    }
    RegistryContract.prototype.publicKeyToAddress = function (publicKey) {
        return ":".concat(new smart_buffer_1.default(publicKey).toHexString());
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.reader.gqlQueryMessages((0, misc_1.getContractMessagesQuery)(this.publicKeyToAddress(publicKey), this.contractAddress))];
                    case 2:
                        messages = _a.sent();
                        if (messages.length) {
                            return [2 /*return*/, this.decodePublicKeyToAddressMessageBody(messages[0].body)];
                        }
                        else {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.reader.gqlQueryMessages((0, misc_1.getContractMessagesQuery)(address.substring(1), this.contractAddress))];
                    case 2:
                        messages = _a.sent();
                        if (messages.length) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.contract.methods
                            // @ts-ignore
                            .attachAddress({ publicKey: (0, misc_1.publicKeyToBigIntString)(publicKey) })
                            .sendWithResult({
                            from: new everscale_inpage_provider_1.Address(address),
                            amount: '1000000000',
                            bounce: false,
    ...
    RegistryContract.prototype.decodePublicKeyToAddressMessageBody = function (body) {
        var data = core_1.default.nekoton.decodeEvent(body, JSON.stringify(REGISTRY_ABI), 'PublicKeyToAddress');
        if (!data) {
