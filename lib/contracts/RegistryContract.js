        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.blockchainController.gqlQueryMessages((0, misc_1.getContractMessagesQuery)(this.publicKeyToAddress(publicKey), this.contractAddress))];
                    case 2:
                        messages = _a.sent();
                        if (messages.length) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.blockchainController.gqlQueryMessages((0, misc_1.getContractMessagesQuery)(address.substring(1), this.contractAddress))];
                    case 2:
                        messages = _a.sent();
                        if (messages.length) {
