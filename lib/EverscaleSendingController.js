...
var EverscaleSendingController = /** @class */ (function (_super) {
    ...
    function EverscaleSendingController(props) {
        ...
        _this.reader = new _1.EverscaleReadingController(props);
        return _this;
    }
    // wallet block
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        chunks = sdk_1.MessageChunks.packContentInChunks(serviceCode, keypair.publicKey, encryptedContent);
                        ...
                        return [4 /*yield*/, this.reader.mailerContract.sendSmallMail(me.address, keypair.publicKey, uniqueId, recipientKeys[0].address, recipientKeys[0].key, chunks[0])];
                    case 2:
                        transaction = _b.sent();
                        console.log('transaction: ', transaction);
                        return [3 /*break*/, 4];
                    case 3: throw new Error('Multisending is not supported for now');
                    case 4: 
