...
var EverscaleReadingController = /** @class */ (function(_super) {
    ...
    EverscaleReadingController.prototype.decodePushMessageBody = function(body) {
    ...
    EverscaleReadingController.prototype.decodeContentMessageBody = function(body) {
        var data = core_1.default.nekoton.decodeEvent(
            body,
            JSON.stringify(EverscaleContract_1.CONTRACT_ABI),
            'MailContent',
    ...
    EverscaleReadingController.prototype.queryMessagesList = function(
        recipientAddress,
        sinceDate,
        untilDate,
        options,
